...
export class InitialSchema1785608131024 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."role" AS ENUM('cryohealth_admin', 'facility_admin', 'chw', 'viewer')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "observations" ADD CONSTRAINT "FK_53e7cf2e3f21fa15663145b8a56" FOREIGN KEY ("lakeId") REFERENCES "lakes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "hazard_scores" ADD CONSTRAINT "FK_98d936ac2809014aa39e01b97a0" FOREIGN KEY ("lakeId") REFERENCES "lakes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "alerts" ADD CONSTRAINT "FK_b7b218b24ef9473a8b7b654e1e9" FOREIGN KEY ("lakeId") REFERENCES "lakes"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "alerts" ADD CONSTRAINT "FK_84b65b600b31ce411f50b0900a8" FOREIGN KEY ("issuedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "chw_cases" ADD CONSTRAINT "FK_02ac278defac47a4cd8b51b75f4" FOREIGN KEY ("chwId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "sync_log" ADD CONSTRAINT "FK_0049d69ee32bb18191f6aed04f3" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "audit" ADD CONSTRAINT "FK_0de728fd71d24466b7b4f00f49c" FOREIGN KEY ("actorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "audit" DROP CONSTRAINT "FK_0de728fd71d24466b7b4f00f49c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sync_log" DROP CONSTRAINT "FK_0049d69ee32bb18191f6aed04f3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "chw_cases" DROP CONSTRAINT "FK_02ac278defac47a4cd8b51b75f4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "alerts" DROP CONSTRAINT "FK_84b65b600b31ce411f50b0900a8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "alerts" DROP CONSTRAINT "FK_b7b218b24ef9473a8b7b654e1e9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_a52777ccb99dc7c3a7bbaeb792c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "hazard_scores" DROP CONSTRAINT "FK_98d936ac2809014aa39e01b97a0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "observations" DROP CONSTRAINT "FK_53e7cf2e3f21fa15663145b8a56"`,
    );
    await queryRunner.query(`DROP TABLE "audit"`);
    await queryRunner.query(`DROP TABLE "sync_log"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4fb5b6abb73d4bb142e1675402"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3b976b08fed8a1bc74dcdf3933"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_fadbaa3cc5fca15221dfca36bb"`,
    );
